defmodule AOC11 do
  def find_all_flashing(octopusses, step) do
    {stepped, flashes} = engergize(octopusses)

    if flashes == 100 do
      step
    else
      find_all_flashing(stepped, step + 1)
    end
  end
...
IO.puts(AOC11.find_all_flashing(octopusses, 1))
